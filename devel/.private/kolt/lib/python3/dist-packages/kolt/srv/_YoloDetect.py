...
"""autogenerated by genpy from kolt/YoloDetectRequest.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(YoloDetectRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from kolt/YoloDetectResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class YoloDetectResponse(genpy.Message):
  ...
  _type = "kolt/YoloDetectResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """vision_msgs/Detection2DArray detection
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(YoloDetectResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.detection is None:
        self.detection = vision_msgs.msg.Detection2DArray()
    else:
      self.detection = vision_msgs.msg.Detection2DArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.detection.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.detection.detections:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.detection.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        self.detection.detections.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class YoloDetect(object):
  ...
  _request_class  = YoloDetectRequest
  _response_class = YoloDetectResponse
